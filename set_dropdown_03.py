...
driver.get("https://www.adidas.co.in/women-eoss")
# KEY POINT: Identify the dropdown and click on it
WOMEN = driver.find_element("xpath", "//a[contains(text(),'WOMEN')]")
WOMEN.click()
# Sleep is one way to pause while the page elements load
time.sleep(1)
# KEY POINT: Locate a particular option and click on it
driver.find_element("xpath", "//a[@href='/women-shoes']//span[contains(text(),'FOOTWEAR')]").click()
