...
button  = driver.find_element("xpath" ,"//button[@class='Button_button__URNp+ Button_primary__d2Jt3 Button_fullwidth__0HLEu']")
button.click()
...
try:
    driver.find_element("xpath", "//input[@id='current-password']")
